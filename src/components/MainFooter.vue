<template>
  <div class="bg-black text-white text-center float-bottom">
    <TwoCol>
      <template #left>
        <div class="row flex justify-center items-center no-wrap">
          <q-img src="logo.svg" style="width: 60px; height: 60px" alt="ArchPlate Logo" />
          <h5>ArchPlate</h5>
        </div>
      </template>
      <template #right>
